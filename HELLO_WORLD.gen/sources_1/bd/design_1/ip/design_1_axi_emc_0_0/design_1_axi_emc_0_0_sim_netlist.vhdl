...
-- Date        : Sun Jul  2 14:28:24 2023
-- Host        : LAPTOP-GBNTDCHP running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               e:/VIVADO_2022/CMOD_ARTIX_7/HELLO_WORLD/HELLO_WORLD.gen/sources_1/bd/design_1/ip/design_1_axi_emc_0_0/design_1_axi_emc_0_0_sim_netlist.vhdl
...
entity design_1_axi_emc_0_0_axi_emc_address_decode is
  port (
    ...
    \PERBIT_GEN[0].XORCY_i1\ : in STD_LOGIC;
    \PERBIT_GEN[1].MULT_AND_i1\ : in STD_LOGIC;
    \PERBIT_GEN[1].MULT_AND_i1_0\ : in STD_LOGIC;
...
\PERBIT_GEN[1].MULT_AND_i1_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EEE0EEEE"
        ...
        port map (
      I0 => \PERBIT_GEN[1].MULT_AND_i1\,
      I1 => \PERBIT_GEN[1].MULT_AND_i1_0\,
...
entity \design_1_axi_emc_0_0_ld_arith_reg__parameterized3\ is
  port (
    ...
    bus2ip_reset : in STD_LOGIC;
    s_axi_aclk : in STD_LOGIC;
    \PERBIT_GEN[14].MUXCY_i1_0\ : in STD_LOGIC;
...
entity design_1_axi_emc_0_0_mem_state_machine is
  port (
    ...
    \PERBIT_GEN[0].XORCY_i1\ : in STD_LOGIC_VECTOR ( 14 downto 0 );
    \PERBIT_GEN[0].FF_RST1_GEN.FDSE_i1_0\ : in STD_LOGIC;
    ...
    \PERBIT_GEN[4].XORCY_i1_2\ : in STD_LOGIC;
    \PERBIT_GEN[4].XORCY_i1_3\ : in STD_LOGIC;
    \PERBIT_GEN[0].FF_RST1_GEN.FDSE_i1_1\ : in STD_LOGIC;
    ...
    addr_sm_ps_IDLE_reg_i_7_0 : in STD_LOGIC;
    transaction_done_reg_reg_0 : in STD_LOGIC;
    \PERBIT_GEN[0].XORCY_i1_3\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
...
\FSM_sequential_emc_addr_ps[2]_i_10\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"A8"
    )
        port map (
...
entity design_1_axi_emc_0_0_counters is
  port (
    ...
    \PERBIT_GEN[0].Q_I_GEN_SUB.q_i_ns_reg_13\ : in STD_LOGIC;
    twr_rec_cnt_en_int : in STD_LOGIC;
    \PERBIT_GEN[14].MUXCY_i1\ : in STD_LOGIC;
    \PERBIT_GEN[13].Q_I_GEN_SUB.q_i_ns_reg\ : in STD_LOGIC;
    \PERBIT_GEN[12].Q_I_GEN_SUB.q_i_ns_reg\ : in STD_LOGIC;
    \PERBIT_GEN[11].Q_I_GEN_SUB.q_i_ns_reg\ : in STD_LOGIC;
    \PERBIT_GEN[10].Q_I_GEN_SUB.q_i_ns_reg\ : in STD_LOGIC;
...
T_WRREC_CNT_I: entity work.\design_1_axi_emc_0_0_ld_arith_reg__parameterized3\
     port map (
      ...
      \PERBIT_GEN[14].MUXCY_i1_0\ => \PERBIT_GEN[14].MUXCY_i1\,
...
COUNTERS_I: entity work.design_1_axi_emc_0_0_counters
     port map (
      ...
      \PERBIT_GEN[14].MUXCY_i1\ => MEM_STATE_MACHINE_I_n_77,
      ...
      \PERBIT_GEN[3].MUXCY_i1\ => MEM_STATE_MACHINE_I_n_78,
      \PERBIT_GEN[3].MUXCY_i1_0\ => MEM_STATE_MACHINE_I_n_79,
...
MEM_STATE_MACHINE_I: entity work.design_1_axi_emc_0_0_mem_state_machine
     port map (
      ...
      \PERBIT_GEN[0].FF_RST0_GEN.FDRE_i1_0\ => \^pend_wrreq_reg_0\,
      ...
      \PERBIT_GEN[0].FF_RST1_GEN.FDSE_i1_1\ => ADDR_COUNTER_MUX_I_n_40,
      ...
      \PERBIT_GEN[0].XORCY_i1\(14) => twr_rec_cnt(0),
      \PERBIT_GEN[0].XORCY_i1\(13) => twr_rec_cnt(1),
      \PERBIT_GEN[0].XORCY_i1\(12) => twr_rec_cnt(2),
      \PERBIT_GEN[0].XORCY_i1\(11) => twr_rec_cnt(3),
      \PERBIT_GEN[0].XORCY_i1\(10) => twr_rec_cnt(4),
      \PERBIT_GEN[0].XORCY_i1\(9) => twr_rec_cnt(5),
      \PERBIT_GEN[0].XORCY_i1\(8) => twr_rec_cnt(6),
      \PERBIT_GEN[0].XORCY_i1\(7) => twr_rec_cnt(7),
      \PERBIT_GEN[0].XORCY_i1\(6) => twr_rec_cnt(8),
      \PERBIT_GEN[0].XORCY_i1\(5) => twr_rec_cnt(9),
      \PERBIT_GEN[0].XORCY_i1\(4) => twr_rec_cnt(10),
      \PERBIT_GEN[0].XORCY_i1\(3) => twr_rec_cnt(11),
      \PERBIT_GEN[0].XORCY_i1\(2) => twr_rec_cnt(12),
      \PERBIT_GEN[0].XORCY_i1\(1) => twr_rec_cnt(13),
      \PERBIT_GEN[0].XORCY_i1\(0) => twr_rec_cnt(14),
      ...
      \PERBIT_GEN[0].XORCY_i1_1\(3) => twph_cnt(0),
      \PERBIT_GEN[0].XORCY_i1_1\(2) => twph_cnt(1),
      \PERBIT_GEN[0].XORCY_i1_1\(1) => twph_cnt(2),
      \PERBIT_GEN[0].XORCY_i1_1\(0) => twph_cnt(3),
      \PERBIT_GEN[0].XORCY_i1_2\(3) => tpacc_cnt(0),
      \PERBIT_GEN[0].XORCY_i1_2\(2) => tpacc_cnt(1),
      \PERBIT_GEN[0].XORCY_i1_2\(1) => tpacc_cnt(2),
      \PERBIT_GEN[0].XORCY_i1_2\(0) => tpacc_cnt(3),
      \PERBIT_GEN[0].XORCY_i1_3\(3) => p_0_in(0),
      \PERBIT_GEN[0].XORCY_i1_3\(2) => p_0_in(1),
      \PERBIT_GEN[0].XORCY_i1_3\(1) => p_0_in(2),
      \PERBIT_GEN[0].XORCY_i1_3\(0) => p_0_in(3),
      \PERBIT_GEN[10].Q_I_GEN_SUB.q_i_ns_reg\ => \T_WRREC_CNT_I/PERBIT_GEN[10].Q_I_GEN_SUB.q_i_ns_reg\,
      \PERBIT_GEN[11].Q_I_GEN_SUB.q_i_ns_reg\ => \T_WRREC_CNT_I/PERBIT_GEN[11].Q_I_GEN_SUB.q_i_ns_reg\,
      \PERBIT_GEN[12].Q_I_GEN_SUB.q_i_ns_reg\ => \T_WRREC_CNT_I/PERBIT_GEN[12].Q_I_GEN_SUB.q_i_ns_reg\,
      \PERBIT_GEN[13].Q_I_GEN_SUB.q_i_ns_reg\ => \T_WRREC_CNT_I/PERBIT_GEN[13].Q_I_GEN_SUB.q_i_ns_reg\,
      ...
      \PERBIT_GEN[4].Q_I_GEN_SUB.q_i_ns_reg\ => \T_WRREC_CNT_I/PERBIT_GEN[4].Q_I_GEN_SUB.q_i_ns_reg\,
      \PERBIT_GEN[4].XORCY_i1\ => COUNTERS_I_n_41,
      \PERBIT_GEN[4].XORCY_i1_0\ => COUNTERS_I_n_42,
      \PERBIT_GEN[4].XORCY_i1_1\ => COUNTERS_I_n_43,
      \PERBIT_GEN[4].XORCY_i1_2\ => COUNTERS_I_n_39,
      \PERBIT_GEN[4].XORCY_i1_3\ => \^perbit_gen[1].ff_rst0_gen.fdre_i1_0\,
      \PERBIT_GEN[5].Q_I_GEN_SUB.q_i_ns_reg\ => \T_WRREC_CNT_I/PERBIT_GEN[5].Q_I_GEN_SUB.q_i_ns_reg\,
      \PERBIT_GEN[6].Q_I_GEN_SUB.q_i_ns_reg\ => \T_WRREC_CNT_I/PERBIT_GEN[6].Q_I_GEN_SUB.q_i_ns_reg\,
      \PERBIT_GEN[7].Q_I_GEN_SUB.q_i_ns_reg\ => \T_WRREC_CNT_I/PERBIT_GEN[7].Q_I_GEN_SUB.q_i_ns_reg\,
      \PERBIT_GEN[8].Q_I_GEN_SUB.q_i_ns_reg\ => \T_WRREC_CNT_I/PERBIT_GEN[8].Q_I_GEN_SUB.q_i_ns_reg\,
...
architecture STRUCTURE of design_1_axi_emc_0_0_axi_emc_native_interface is
  ...
  signal \FSM_sequential_emc_addr_ps[2]_i_14_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_emc_addr_ps[2]_i_11\ : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of \FSM_sequential_emc_addr_ps[2]_i_13\ : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of \FSM_sequential_emc_addr_ps[2]_i_14\ : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of \FSM_sequential_emc_addr_ps[2]_i_17\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \FSM_sequential_emc_addr_ps[2]_i_3\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of \FSM_sequential_emc_addr_ps[2]_i_4\ : label is "soft_lutpair45";
  attribute SOFT_HLUTNM of \FSM_sequential_emc_addr_ps[2]_i_5\ : label is "soft_lutpair60";
  attribute SOFT_HLUTNM of \FSM_sequential_emc_addr_ps[2]_i_7\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \FSM_sequential_emc_addr_ps[2]_i_9\ : label is "soft_lutpair61";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of \axi_trans_size_reg[0]_i_1\ : label is "soft_lutpair56";
  ...
  attribute SOFT_HLUTNM of \bus2ip_BE_reg[1]_i_3\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \bus2ip_BE_reg[3]_i_4\ : label is "soft_lutpair43";
  ...
  attribute SOFT_HLUTNM of \rd_data_count[0]_i_1\ : label is "soft_lutpair57";
  attribute SOFT_HLUTNM of \rd_data_count[1]_i_1\ : label is "soft_lutpair57";
...
AXI_EMC_ADDRESS_DECODE_INSTANCE_I: entity work.design_1_axi_emc_0_0_axi_emc_address_decode
     port map (
      ...
      \PERBIT_GEN[0].Q_I_GEN_SUB.q_i_ns_reg\ => \PERBIT_GEN[0].Q_I_GEN_SUB.q_i_ns_reg\,
      \PERBIT_GEN[0].XORCY_i1\ => \PERBIT_GEN[0].XORCY_i1_i_2_n_0\,
      \PERBIT_GEN[1].FF_RST0_GEN.FDRE_i1\ => S,
      \PERBIT_GEN[1].MULT_AND_i1\ => \PERBIT_GEN[1].MULT_AND_i1\,
      \PERBIT_GEN[1].MULT_AND_i1_0\ => \PERBIT_GEN[1].MULT_AND_i1_0\,
      ...
      addr_sm_ps_IDLE_reg_i_5_0 => \FSM_sequential_emc_addr_ps[2]_i_7_n_0\,
      ...
      addr_sm_ps_IDLE_reg_reg_1 => \FSM_sequential_emc_addr_ps[2]_i_3_n_0\,
      ...
      addr_sm_ps_IDLE_reg_reg_5 => \FSM_sequential_emc_addr_ps[2]_i_5_n_0\,
      addr_sm_ps_IDLE_reg_reg_6 => \FSM_sequential_emc_addr_ps[2]_i_4_n_0\,
...
\FSM_sequential_emc_addr_ps[2]_i_15\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => \FSM_sequential_emc_addr_ps[2]_i_8\,
      O => \^burst_addr_cnt_reg[5]_0\
    );
\FSM_sequential_emc_addr_ps[2]_i_16\: unisim.vcomponents.LUT6
    generic map(
...
\FSM_sequential_emc_addr_ps[2]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
RDATA_FIFO_I: entity work.design_1_axi_emc_0_0_srl_fifo_rbu_f
     port map (
      ...
      \FSM_sequential_emc_addr_ps_reg[0]_3\ => \FSM_sequential_emc_addr_ps[2]_i_5_n_0\,
...
architecture STRUCTURE of design_1_axi_emc_0_0_axi_emc is
  ...
  signal AXI_EMC_NATIVE_INTERFACE_I_n_80 : STD_LOGIC;
...
AXI_EMC_NATIVE_INTERFACE_I: entity work.design_1_axi_emc_0_0_axi_emc_native_interface
     port map (
      ...
      \FSM_sequential_emc_addr_ps[2]_i_8\ => EMC_CTRL_I_n_70,
      ...
      \MEM_DECODE_GEN[0].cs_out_i_reg[0]\ => AXI_EMC_NATIVE_INTERFACE_I_n_67,
      \MEM_DECODE_GEN[0].cs_out_i_reg[0]_0\ => AXI_EMC_NATIVE_INTERFACE_I_n_69,
      \MEM_DECODE_GEN[0].cs_out_i_reg[0]_1\ => AXI_EMC_NATIVE_INTERFACE_I_n_70,
      \MEM_DECODE_GEN[0].rdce_out_i_reg[0]\ => AXI_EMC_NATIVE_INTERFACE_I_n_44,
      \MEM_DECODE_GEN[0].rdce_out_i_reg[0]_0\ => AXI_EMC_NATIVE_INTERFACE_I_n_62,
      \MEM_DECODE_GEN[0].rdce_out_i_reg[0]_1\ => AXI_EMC_NATIVE_INTERFACE_I_n_71,
      \MEM_DECODE_GEN[0].rdce_out_i_reg[0]_2\ => AXI_EMC_NATIVE_INTERFACE_I_n_72,
      ...
      \PERBIT_GEN[1].MULT_AND_i1\ => EMC_CTRL_I_n_64,
      \PERBIT_GEN[1].MULT_AND_i1_0\ => EMC_CTRL_I_n_71,
      ...
      \burst_addr_cnt_reg[5]_0\ => AXI_EMC_NATIVE_INTERFACE_I_n_46,
      \burst_addr_cnt_reg[7]_0\ => AXI_EMC_NATIVE_INTERFACE_I_n_39,
      \burst_addr_cnt_reg[7]_1\ => EMC_CTRL_I_n_75,
      burst_cnt_i(0 to 7) => \IPIC_IF_I/burst_cnt_i\(0 to 7),
      \burstlength_reg_reg[0]_0\ => AXI_EMC_NATIVE_INTERFACE_I_n_81,
      \burstlength_reg_reg[5]_0\ => AXI_EMC_NATIVE_INTERFACE_I_n_43,
      bus2Mem_RdReq => bus2Mem_RdReq,
      ...
      s_axi_mem_wvalid => s_axi_mem_wvalid,
      s_axi_mem_wvalid_0 => AXI_EMC_NATIVE_INTERFACE_I_n_40,
      temp_bus2ip_cs => temp_bus2ip_cs,
      transaction_complete_reg_i_2 => EMC_CTRL_I_n_76,
      type_of_xfer_reg_reg_0 => AXI_EMC_NATIVE_INTERFACE_I_n_80
    );
EMC_CTRL_I: entity work.design_1_axi_emc_0_0_EMC
     port map (
      ...
      \DATAWIDTH_MATCH_GEN.addr_cnt_i_reg[0]_0\ => AXI_EMC_NATIVE_INTERFACE_I_n_80,
      \DATAWIDTH_MATCH_GEN.addr_cnt_i_reg[1]\ => EMC_CTRL_I_n_80,
      \DATAWIDTH_MATCH_GEN.addr_cnt_i_reg[1]_0\ => AXI_EMC_NATIVE_INTERFACE_I_n_81,
      \DATAWIDTH_MATCH_GEN.addr_cnt_i_reg[1]_1\ => AXI_EMC_NATIVE_INTERFACE_I_n_82,
      \DATA_STORE_GEN[24].WRDATA_REG\(31 downto 0) => temp_bus2ip_data(31 downto 0),
      \FSM_sequential_crnt_state_reg[0]\ => EMC_CTRL_I_n_75,
      \FSM_sequential_crnt_state_reg[0]_0\ => AXI_EMC_NATIVE_INTERFACE_I_n_67,
      ...
      \FSM_sequential_crnt_state_reg[1]_3\ => AXI_EMC_NATIVE_INTERFACE_I_n_72,
      \FSM_sequential_crnt_state_reg[1]_4\ => AXI_EMC_NATIVE_INTERFACE_I_n_70,
      \FSM_sequential_crnt_state_reg[2]\ => EMC_CTRL_I_n_71,
      \FSM_sequential_crnt_state_reg[2]_0\ => EMC_CTRL_I_n_77,
      \FSM_sequential_crnt_state_reg[3]\ => AXI_EMC_NATIVE_INTERFACE_I_n_69,
      \FSM_sequential_crnt_state_reg[4]\ => EMC_CTRL_I_n_65,
      \FSM_sequential_emc_addr_ps_reg[2]\ => AXI_EMC_NATIVE_INTERFACE_I_n_46,
      \FSM_sequential_emc_addr_ps_reg[2]_0\ => AXI_EMC_NATIVE_INTERFACE_I_n_44,
      \FSM_sequential_emc_addr_ps_reg[2]_1\ => AXI_EMC_NATIVE_INTERFACE_I_n_40,
      ...
      Q(1) => \MEM_STATE_MACHINE_I/crnt_state\(3),
      Q(0) => \MEM_STATE_MACHINE_I/crnt_state\(1),
      \RDDATA_PATH_MUX_GEN.ASYNC_ADDR_CNT_GEN.addr_cnt_d1[0]_i_10\ => AXI_EMC_NATIVE_INTERFACE_I_n_45,
      \RDDATA_PATH_MUX_GEN.ASYNC_ADDR_CNT_GEN.addr_cnt_d1[0]_i_12\ => AXI_EMC_NATIVE_INTERFACE_I_n_43,
      \RDDATA_PATH_MUX_GEN.ASYNC_ADDR_CNT_GEN.addr_cnt_d1[0]_i_5\ => AXI_EMC_NATIVE_INTERFACE_I_n_68,
      ...
      mem_wen => mem_wen,
      pend_rdreq => \IPIC_IF_I/pend_rdreq\,
      pend_rdreq_i_3 => AXI_EMC_NATIVE_INTERFACE_I_n_66,
      pend_rdreq_reg => AXI_EMC_NATIVE_INTERFACE_I_n_62,
      pend_wrreq => \IPIC_IF_I/pend_wrreq\,
      pend_wrreq_reg => EMC_CTRL_I_n_61,
      pend_wrreq_reg_0 => EMC_CTRL_I_n_66,
      pend_wrreq_reg_1 => AXI_EMC_NATIVE_INTERFACE_I_n_39,
      rd_fifo_wr_en => rd_fifo_wr_en,
      rdce_out_i => \AXI_EMC_ADDRESS_DECODE_INSTANCE_I/rdce_out_i\,
      rdclk => rdclk,
      read_ack_d_3 => \MEM_STEER_I/read_ack_d_3\,
...
entity design_1_axi_emc_0_0 is
  ...
  attribute x_core_info of design_1_axi_emc_0_0 : entity is "axi_emc,Vivado 2022.2";
